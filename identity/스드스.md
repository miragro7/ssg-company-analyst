...
- Mir Kim의 의사결정을 지원하는 전략적 인사이트 제공
...
```python
import sys; sys.path.insert(0, "/home/ubuntu/뉴블로그")
...
### 파이프라인 구성
- 통합 파이프라인 : /home/ubuntu/뉴블로그/sdeus_pipeline.py
- HTML 리포터    : /home/ubuntu/뉴블로그/sdeus_reporter.py
- Word 스킬      : /home/ubuntu/뉴블로그/skills/sds-word-writer/scripts/generate.py
- 저장 경로      : /home/ubuntu/뉴블로그/report/
...
### Word 단독 변환 (기존 HTML → Word만 필요할 때)
- 스킬 출처: https://github.com/bennhee4sds-sudo/shared/tree/main/Skills/sds-word-writer
- content.json 스키마: title / date / toc / sections[{numeral, heading, bullets}]
  - bullet kind: dash / dot / note / table / subhead / circled / ordered
  - annotation: {"text": "파란 주석", "anchor": "앵커 단어"}
